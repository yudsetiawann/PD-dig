            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <a href="{{ route('public.athletes.all') }}"
                    ...
                    <div class="mt-4 text-slate-900 dark:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor"
                            class="size-12 text-blue-600 group-hover:scale-110 transition-transform">
                ...
                <a href="{{ route('public.coaches') }}"
                    ...
                    <div class="mt-4 text-slate-900 dark:text-white">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor"
                            class="size-12 text-indigo-600 group-hover:scale-110 transition-transform">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('public.units') }}"
                    ...
                    <div class="mt-4 text-slate-900 dark:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor"
                            class="size-12 text-emerald-600 group-hover:scale-110 transition-transform">
                            <path stroke-linecap="round" stroke-linejoin="round"
