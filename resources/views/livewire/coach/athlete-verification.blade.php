            ...
            @if ($athletes->isEmpty())
                <div class="p-6">
                    <x-empty-state
                        ...
                        description="Belum ada anggota baru yang menunggu verifikasi saat ini."
                    />
                </div>
            @else
                                ...
                                <tr wire:key="athlete-{{ $athlete->id }}"
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap">
                                        <div class="flex flex-col space-y-2 items-start">
                                            <x-status-badge variant="blue">{{ $athlete->unit->name ?? 'Tanpa Unit' }}</x-status-badge>
                                            <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                                                <span
                                                    class="font-medium mr-1">{{ $athlete->level?->name ?? '-' }}</span>
                                                <span class="text-gray-400 text-xs mx-1">•</span>
                                                <span class="text-xs text-gray-500">Sejak
                                                    {{ $athlete->join_year }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-5">
                                        <div class="flex flex-col space-y-1.5 text-sm text-gray-600 dark:text-gray-400">
                                            <div class="flex items-center" title="Tempat, Tanggal Lahir">
                                                <svg class="shrink-0 mr-2 h-4 w-4 text-gray-400" fill="none"
                                            ...
                                            <div class="flex items-center" title="WhatsApp">
                                                <svg class="shrink-0 mr-2 h-4 w-4 text-green-500" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
