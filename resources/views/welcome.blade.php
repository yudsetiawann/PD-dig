<x-app-layout title="Welcome">
  ...
  <section class="relative min-h-[70vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
      ...
      <!-- Overlay Gradient -->
      <div class="absolute inset-0 bg-linear-to-t from-slate-950/80 via-slate-950/70 to-black/30">
      </div>
    </div>
    ...
    <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-48 text-center">
      ...
      <p
        ...
        Temukan dan beli tiket untuk berbagai kejuaraan, ujian kenaikan tingkat, dan event lainnya di Perisai Diri
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div
          ...
          <p class="text-slate-600 dark:text-slate-400">Lakukan pembayaran dengan metode yang Anda pilih melalui payment
            gateway.</p>
        </div>
